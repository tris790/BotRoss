...
function Install(bot) {
  var playCommand = bot.registerCommand(
    ...
    },
    {
      ...
      fullDescription: "Downloads an audio track then plays it.",
  ...
  var stop = bot.registerCommand(
    ...
    },
    {
      ...
      fullDescription: "Stops playing music and clears the playlist."
    }
  );
  ...
  var resume = bot.registerCommand(
    ...
    },
    {
      ...
      fullDescription: "Resumes the current track."
    }
  );
  var pause = bot.registerCommand(
    ...
    },
    {
      ...
      fullDescription: "Pauses the current audio track."
    }
  );
  var volume = bot.registerCommand(
    ...
    {
      description: "Ajusts the volume (While not playing)."
    }
  );
